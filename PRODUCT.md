# Wayfinder product context

## Product

Wayfinder is the local, single-operator run desk for theHarvester. It turns finite enumeration runs and imported result files into durable, searchable evidence without turning theHarvester into a monitoring service.
...
- Import existing theHarvester JSON or JSONL evidence.
