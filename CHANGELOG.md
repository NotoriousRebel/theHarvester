...
- Added run-bound passive-source and active-action attribution, execution outcomes, yield counts, and screenshot artifact references to completed JSONL and SQLite evidence.
