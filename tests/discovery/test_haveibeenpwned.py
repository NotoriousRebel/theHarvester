...
async def test_public_breach_names_reach_completed_result_and_jsonl(
    ...
    assert {'type': 'breach', 'value': 'Adobe', 'sources': ['haveibeenpwned'], 'actions': []} in records
    assert {'type': 'breach', 'value': 'ExampleBreach', 'sources': ['haveibeenpwned'], 'actions': []} in records
